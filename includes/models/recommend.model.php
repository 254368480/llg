...
class RecommendModel extends BaseModel
{
    ...
    function get_recommended_goods($recom_id, $num, $default_image = true, $mall_cate_id = 0)
    {
        ...
        if ($recom_id == REC_NEW)
        {
            ...
            $sql = "SELECT g.goods_id, g.goods_name, g.default_image, g.integral, gs.price, gs.stock " .
        ...
        {
            /* 推荐商品 */
            $sql = "SELECT g.goods_id, g.goods_name, g.integral, g.default_image, gs.price, gs.stock " .
