...
?>
                            <li>
                                ...
                                <h3><a href="<?php echo url('app=goods&id=' . $this->_var['sgoods']['goods_id']. ''); ?>" target="_blank"><?php echo sub_str($this->_var['sgoods']['goods_name'],20); ?></a></h3>
                                <p><?php echo price_format($this->_var['sgoods']['price']); ?></p>
								<p> + <?php echo $this->_var['sgoods']['integral']; ?>分</p>
                            </li>
