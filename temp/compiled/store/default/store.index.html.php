...
?>
                            <li>
                                ...
                                <h3><a href="<?php echo url('app=goods&id=' . $this->_var['rgoods']['goods_id']. ''); ?>" target="_blank"><?php echo sub_str($this->_var['rgoods']['goods_name'],20); ?></a></h3>
                                <p><?php echo price_format($this->_var['rgoods']['price']); ?></p>
								<p>+ <?php echo $this->_var['rgoods']['integral']; ?>分</p>
                            </li>
...
?>
                            <li>
                                ...
                                <h3><a href="<?php echo url('app=goods&id=' . $this->_var['ngoods']['goods_id']. ''); ?>" target="_blank"><?php echo sub_str($this->_var['ngoods']['goods_name'],20); ?></a></h3>
                                <p><?php echo price_format($this->_var['ngoods']['price']); ?></p>
								<p> + <?php echo $this->_var['ngoods']['integral']; ?>分</p>
                            </li>
                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        </ul>
                    </div>
