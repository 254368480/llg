<link href="themes/store/default/styles/default/kf.css" rel="stylesheet" type="text/css" />
        <div class="user">
...
?>
                ...
                <p class="kf">
                	...
                	<a target=_parent href="tencent://message/?uin=<?php echo htmlspecialchars($this->_var['store']['im_qq']); ?>&Site=<?php echo htmlspecialchars($this->_var['store']['store_name']); ?>&Menu=yes"><img src="/themes/mall/default/styles/default/img/pa.gif" /></a>   
                    <?php endif; ?>
...
?>
        ...
        <?php endif; ?>
		<?php if ($this->_var['store']['ibangkf'] != ''): ?>
        <script type="text/javascript" src="http://c.ibangkf.com/i/c-<?php echo $this->_var['store']['ibangkf']; ?>.js"></script>
		<?php endif; ?>
