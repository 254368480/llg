...
?>
    <tr class="tatr2">
	  ...
	  <td><?php echo $this->_var['user']['integral']; ?>分</td>
	  <td>￥<?php echo $this->_var['user']['money']; ?></td>
      <td><?php echo $this->_var['user']['grade']; ?></td>
      <td> <?php if ($this->_var['user']['im_qq']): ?>QQ: <?php echo htmlspecialchars($this->_var['user']['im_qq']); ?><br />
        <?php endif; ?>
        <?php if ($this->_var['user']['im_msn']): ?><?php echo htmlspecialchars($this->_var['user']['im_msn']); ?><br />
        <?php endif; ?></td>
