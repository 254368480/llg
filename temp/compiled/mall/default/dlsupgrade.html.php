...
?>
                                <tr>
                                    ...
                                    <td align="center"><a href="/index.php?app=member&act=to_upgrade&id=<?php echo $this->_var['value']['id']; ?>">通过</a> | <a href="/index.php?app=member&act=upgrade&id=<?php echo $this->_var['value']['id']; ?>&do=0">拒绝</a></td>
                                </tr>
