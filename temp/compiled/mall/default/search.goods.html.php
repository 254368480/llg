                    ...
                    <li>
                        ...
                        <h3>
                            <span class="text_link">
                                <span class="depict">
                                    <a href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. ''); ?>" target="_blank"><?php echo sub_str($this->_var['goods']['goods_name'],20); ?></a>
                                </span>
                               <!-- <span class="info">
							...
							<span class="price">+ <?php echo $this->_var['goods']['integral']; ?>分</span>
