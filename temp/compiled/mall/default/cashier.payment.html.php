...
<div class="flow_chart">
    ...
    <div class="pos_x3 bg_c1" title="�µ���ɲ�֧��"></div>
</div>
...
<div class="content">
    ...
    <div class="module_common">
        <div class="step_main">
            <div class="clue_on"><h4>�����ύ�ɹ���</h4><p>���Ķ����ѳɹ����ɣ�ѡ�������õ�֧����ʽ����֧��</p></div>
            <div class="order_information">
                <h3>
                    <b>������&nbsp;:&nbsp;<span><?php echo $this->_var['order']['order_sn']; ?></span></b>
                    <b>�����ܼ�&nbsp;:&nbsp;<span><?php echo price_format($this->_var['order']['order_amount']); ?></span></b>
                </h3>
                <p><a href="<?php echo url('app=buyer_order'); ?>" target="_blank">���������û������е��ҵĶ����鿴�ö���</a></p>
            </div>

            <div class="buy">
                <h3><b class="ico">ѡ��֧����ʽ������</b></h3>
...
?>
            ...
            <div class="make_sure">
                <p>
                    <a href="javascript:$('#goto_pay').submit();" class="btn">ȷ��֧��</a>
                </p>
            </div>
            <!--<div class="remark">
