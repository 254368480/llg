...
<div class="eject_con">
    ...
    <div class="content_line">
        <ul class="foll_in">
			...
			<li>
                <h3>积分:<strong class="color8"><?php echo $this->_var['order']['int_amount']; ?></strong></h3>
                <p><input type="text" id="int_amount" class="text width13" name="int_amount" value="<?php echo $this->_var['order']['int_amount']; ?>" /></p>
            </li>
