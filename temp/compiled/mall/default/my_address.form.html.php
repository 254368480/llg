...
<div class="add">
    ...
    <ul>
        ...
        <li>
            <h3>电话号码:</h3>
            <p><input type="text" class="text width_normal"  name="phone_tel" value="<?php echo $this->_var['address']['phone_mob']; ?>"/><label class="field_message"><span class="field_notice">区号 - 电话号码 - 分机</span></label></p>
        </li>
        <li>
            <h3>手机号码:</h3>
            <p><input type="text" class="text width_normal" name="phone_mob" value="<?php echo $this->_var['address']['phone_tel']; ?>"/><label class="field_message"><span class="field_notice">手机号码</span></label></p>
        </li>
    </ul>
