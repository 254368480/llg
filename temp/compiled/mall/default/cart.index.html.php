...
?>
                        <tr id="cart_item_<?php echo $this->_var['goods']['rec_id']; ?>">
							...
							<td class="align1"><span class="price1"><?php echo $this->_var['goods']['integral']; ?>分</span></td>
                            <td class="align2">
                    ...
                    <div class="buy_foot">
						...
						<p>商品总积分:&nbsp;&nbsp;<strong class="fontsize1" id="cart<?php echo $this->_var['store_id']; ?>_int_amount"><?php echo $this->_var['cart']['int_amount']; ?></strong><strong class="fontsize1">分</strong></p>
                        <p>
