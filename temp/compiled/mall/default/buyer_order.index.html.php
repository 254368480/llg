                    ...
                    <div class="foot">
                        ...
                        <div class="handle">
                            <div style="float:left;">
                                订单总价: <b id="order<?php echo $this->_var['order']['order_id']; ?>_order_amount"><?php echo price_format($this->_var['order']['order_amount']); ?></b><strong style="font-size:16px;color:#FF0000">+ &nbsp;<?php echo $this->_var['order']['int_amount']; ?>分</strong>
