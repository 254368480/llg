                ...
                <div class="ware_list">
                    ...
                    <div class="ware_text">
                        ...
                        <div class="ware_text2">
						  ...
						  <span>积分：&nbsp;:&nbsp;<strong><?php echo $this->_var['goods']['integral']; ?>分</strong></span>
                          <?php if ($this->_var['goods']['sku']): ?><span>货号&nbsp;:&nbsp;<strong><?php echo $this->_var['goods']['sku']; ?></strong></span><?php endif; ?>
                        </div>
                    </div>
                </div>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                <div class="transportation">配送费用&nbsp;:&nbsp;<span><?php echo price_format($this->_var['order_extm']['shipping_fee']); ?><strong>(<?php echo htmlspecialchars($this->_var['order_extm']['shipping_name']); ?>)</strong></span>优惠打折&nbsp;:&nbsp;<span><?php echo price_format($this->_var['order']['discount']); ?></span>订单总价&nbsp;:&nbsp;<b><?php echo price_format($this->_var['order']['order_amount']); ?></b><b> + <?php echo $this->_var['order']['int_amount']; ?>分</b>
                </div>
