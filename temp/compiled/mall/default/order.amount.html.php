                ...
                <div class="make_sure">
                    <p>订单总价:&nbsp;<strong class="fontsize3" id="order_amount"><?php echo price_format($this->_var['goods_info']['amount']); ?></strong><br>
					订单总积分:&nbsp;<strong class="fontsize3" id="int_amount"><?php echo $this->_var['goods_info']['int_amount']; ?></strong><br>
					<?php if ($this->_var['goods_info']['allow_coupon']): ?><input  style="margin-left:0" type="button" class="btn1" onclick="$(this).parent('p').next().toggle();$('#coupon_sn').val('');" /><?php endif; ?></p>
